...
<head>
    ...
    <title>PG-SHOP ADMIN DASHBORD</title>
      <!--  jquery file -->
            ...
            <div class="leftside-header">
                <div class="logo">
                    <a href="" class="on-click">
                       ...
                       <h3><a class="ml-5" href="{{route('admin.dashbord')}}" style="margin-left: 20px;">PG-SHOP</a></h3>
                    </a>
                </div>
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <div class="user-photo">
                            <img alt="profile photo" src="{{asset('/')}}assets/frontend/pgimage/r2.jpeg" />
                        </div>
                        <div class="user-info">
