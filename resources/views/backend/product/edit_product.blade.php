                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select  class="form-control" id="select" name="catagory_id">
                                                            ...
                                                            <option value="{{$catagory->id}}" {{$catagory->id==$product->catagory_id? "selected":""}}>{{$catagory->name}}</option>
                                                            @endforeach
                                                ...
                                                <div class="form-group" >
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" value="{{$product->offer_price}}" name="product_price" id="email2" >
                                                    </div>
                                                </div>
                                                 <div class="form-group">
                                                    <label for="email2" class="col-sm-3 control-label">Product size</label>
                                                    <div class="col-sm-9">
                                                        <select  class="form-control" id="select" name="size_id">
                                                            <option value="" >Select product_size</option>
                                                            @foreach($size as $size)
                                                            <option value="{{$size->id}}" {{($size->id==$product->size)? "selected":""}}>{{$size->size_name}}</option>
                                                            @endforeach
                                                 ...
                                                 <div class="form-group" >
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" value="{{$product->description}}" name="description" id="email2" placeholder="Add product">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="file" class="form-control" id="image" name="subimage" >
                                                    </div>
                                                </div>
